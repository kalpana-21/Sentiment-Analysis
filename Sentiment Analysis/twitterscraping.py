...
def get_tweets(hashtag,datefrom,dateto,limit):
...
datefrom = input("Enter the Start Date")
dateto = input("Enter the End Date")
limit = input("Enter the Tweets limit")
text_tweets = get_tweets(hashtag,datefrom,dateto,limit)
